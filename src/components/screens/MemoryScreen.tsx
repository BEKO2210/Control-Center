            ...
            <div key={memory.id} className="glass-panel-hover p-4 group">
              ...
              <div className="flex items-start justify-between mb-2">
                ...
                <div className="opacity-0 group-hover:opacity-100 flex gap-1 transition-all">
                  <button onClick={() => handleEdit(memory)} className="text-[10px] text-gray-500 hover:text-blue-400">Edit</button>
                  <button onClick={() => deleteMemory(memory.id)} className="text-[10px] text-gray-500 hover:text-red-400">Delete</button>
                </div>
              </div>
